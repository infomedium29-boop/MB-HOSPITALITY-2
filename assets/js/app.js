(() => {
  const T = {
    hr: {
      ...
      'hero.eyebrow':'Vorarlberg · Alpine Hospitality','hero.line1':'Ne savjetujemo iz daljine.','hero.line2':'Ulazimo u vašu operaciju.','hero.sub':'On-site hospitality management, training & business development za hotele, restorane i barove koji žele standarde pretvoriti u stvarno iskustvo gosta.','hero.btn1':'Naš pristup','hero.btn2':'Razgovarajmo','hero.meta1':'20+ godina iskustva','hero.meta2':'Hoteli · Restorani · Barovi','hero.scroll':'Istražite',
    ...
    en: {
      ...
      'hero.eyebrow':'Vorarlberg · Alpine Hospitality','hero.line1':'We don’t consult from a distance.','hero.line2':'We step into your operation.','hero.sub':'On-site hospitality management, training & business development for hotels, restaurants and bars that want to turn standards into a guest experience people can actually feel.','hero.btn1':'Our approach','hero.btn2':'Let’s talk','hero.meta1':'20+ years of experience','hero.meta2':'Hotels · Restaurants · Bars','hero.scroll':'Explore',
  ...
  Object.assign(T.hr, {
    ...
    'exp.lead':'Više od 20 godina profesionalnog iskustva u hotelijerstvu i gastronomiji — od F&B operacija i otvaranja objekata do razvoja standarda, timova i novih ugostiteljskih koncepata.',
    ...
    'experiencePage.meta':'20+ godina profesionalnog iskustva u hotelijerstvu i gastronomiji, F&B upravljanju, otvaranju objekata, treningu i razvoju operacija.',
    'experiencePage.hero':'20+ godina između standarda, ljudi i <span class="gold">stvarnog operativnog rada.</span>',
  ...
  Object.assign(T.de, {
    ...
    'experiencePage.meta':'20+ Jahre Berufserfahrung in Hotellerie und Gastronomie, F&B-Management, Betriebseröffnungen, Training und operativer Entwicklung.','experiencePage.hero':'20+ Jahre zwischen Standards, Menschen und <span class="gold">echtem Betriebsalltag.</span>','experiencePage.lead':'Das Wissen von MB Hospitality & Management stammt aus langjähriger Arbeit in Hotellerie und Gastronomie — aus operativen Situationen, Eröffnungen, F&B, Teamentwicklung und Servicestandards.','experiencePage.contextText':'Der heutige Fokus entstand über Jahre direkter Arbeit in Hotellerie und Gastronomie: Führung von F&B-Betrieben, Restaurant- und Barentwicklung, Vorbereitung und Eröffnung, Mitarbeitertraining, Standardisierung des Service und Geschäftsentwicklung.',
  ...
  // 2026-08-20 — founder, professional experience and authentic photography revision
  Object.assign(T.hr, {
    'home.meta':'Premium hospitality consulting i management u Vorarlbergu, temeljen na 20+ godina iskustva u hotelijerstvu, gastronomiji, F&B managementu, pre-openingu, treningu i razvoju timova.',
    'hero.line1':'20+ godina hospitality iskustva.','hero.line2':'Pretvoreno u konkretne rezultate.','hero.sub':'Praktično znanje iz hotela, restorana, barova i F&B managementa — od pre-openinga i otvaranja do razvoja timova, standarda i iskustva gosta.','hero.btn1':'Iskustvo','hero.meta1':'20+ godina iskustva',
    'footer.copy':'20+ godina hospitality i F&B iskustva pretvorenog u praktičnu podršku za hotele, restorane i barove.',
    'founder.kicker':'Osnivač','founder.title':'Iskustvo iza MB Hospitality & Managementa dolazi iz stvarnog rada.','founder.bio1':'Više od 20 godina rada u Hospitality & F&B industriji — kroz hotele, restorane, barove, vođenje timova, pre-opening i opening projekte, service standards i razvoj operacija.','founder.bio2':'Iskustvo uključuje međunarodne hotelske brandove, 5★ i 4★ Superior okruženja te neposredan rad u Austriji i Vorarlbergu. To je temelj praktičnog pristupa MB Hospitality & Managementa.','founder.fact1':'godina Hospitality & F&B iskustva','founder.fact2':'premium hospitality iskustvo','founder.fact3':'Austrija · Vorarlberg','founder.fact4':'Pre-Opening & Opening iskustvo','founder.more':'Pogledajte profesionalno iskustvo',
    'experienceBehind.title':'Iskustvo koje stoji iza <span class="gold">MB Hospitality & Managementa</span>','experienceBehind.lead':'Od međunarodnih hotelskih brandova do premium objekata u Austriji — profesionalno iskustvo osnivača temelj je načina na koji MB Hospitality danas radi.','experienceBehind.premiumText':'Iskustvo rada u premium i luxury hospitality okruženjima.','experienceBehind.international':'Međunarodni hotelski brandovi','experienceBehind.austria':'Austrijsko hospitality iskustvo','experienceBehind.note':'Navedeni brandovi, objekti i projekti dio su profesionalnog puta Zorana Kušljića i daju kontekst iskustvu na kojem je izgrađen MB Hospitality & Management. Ne predstavljaju klijente ni partnere MB Hospitality & Managementa.',
    'austria.title':'Međunarodno iskustvo. Lokalno razumijevanje.','austria.text':'Falkensteiner Montafon, Löwen Hotel Montafon i Bellucci Bregenz dio su profesionalnog iskustva stečenog u Austriji. Poznavanje lokalnog hospitality okruženja posebno je važno za rad s objektima u Vorarlbergu i alpskoj regiji.','austria.caption':'Austrijsko i alpsko hospitality okruženje.',
    'opening.title':'Iskustvo u projektima od prvog dana.','opening.lead':'Pre-Opening & Opening iskustvo pokazuje da znanje nije vezano samo uz vođenje postojećih objekata, nego i uz postavljanje novih hospitality projekata od samog početka.','opening.canopyType':'Pre-Opening & Opening','opening.canopyText':'Iskustvo sudjelovanja u pre-opening i opening projektu međunarodnog hotelskog branda.','opening.bellucciType':'Restaurant & Bar Opening','opening.bellucciText':'Iskustvo u otvaranju restorana i bara te postavljanju i razvoju operacije od samog početka.','opening.scope1':'F&B Concept','opening.scope2':'Bar & Beverage Program','opening.scope3':'Menu Development','opening.scope4':'Service Standards','opening.scope5':'Operational Setup','opening.scope6':'Team Organization & Training',
    'sectorsHome.title':'Hoteli. Restorani. Barovi.','sectorsHome.lead':'Različita okruženja, različit ritam — ali isti cilj: kvalitetu i standard pretvoriti u iskustvo koje gost stvarno osjeti.',
    'services.title':'Praktično znanje kroz cijeli hospitality sustav.','services.lead':'Fokus je na područjima u kojima iskustvo, jasni standardi i rad s ljudima mogu donijeti konkretan pomak.',
    'process.lead':'Praktičan proces koji stvarno stanje pretvara u jasne korake, razvoj tima i poboljšanja koja ostaju u svakodnevnom radu.','process.5p':'Vraćamo se rezultatu i pratimo kako promjene funkcioniraju kada objekt radi punim intenzitetom.',
    'cta.title':'Razgovarajmo o vašem hospitality projektu.','cta.text':'Ako tražite iskustvo iz prakse, jasne standarde i podršku koja razumije stvarni ritam objekta — razgovarajmo.','cta.button':'Kontaktirajte nas',
    'exp.title':'Iskustvo koje dolazi iz prakse.','exp.lead':'20+ godina profesionalnog iskustva u hotelijerstvu i gastronomiji — od F&B operacija i otvaranja objekata do razvoja standarda, timova i novih hospitality koncepata.',
    'servicesPage.meta':'Hospitality usluge temeljene na 20+ godina iskustva: F&B management, pre-opening, service standards, training, restaurant & bar development i business development.','servicesPage.hero':'Praktično znanje. <span class="gold">Jasni rezultati.</span>','servicesPage.lead':'Podrška hotelima, restoranima i barovima temeljena na 20+ godina stvarnog Hospitality & F&B iskustva.','servicesPage.secTitle':'Područja u kojima iskustvo pretvaramo u praksu.','servicesPage.secLead':'Svaki angažman prilagođava se objektu, fazi poslovanja, ljudima i stvarnim prioritetima.',
    'approachPage.meta':'Praktičan hospitality pristup temeljen na iskustvu, on-site analizi, feedbacku, treningu, implementaciji i follow-upu.','approachPage.hero':'Praktično iskustvo. <span class="gold">Konkretna primjena.</span>','approachPage.lead':'Znamo kako standard izgleda na papiru — i kako mora funkcionirati kada je objekt pun, tim pod pritiskom i gost ispred vas.','approachPage.principleText':'Promatramo što se događa u stvarnim uvjetima: kada je restoran pun, komunikacija mora biti brza, a standard ovisi o tome koliko ga tim razumije i može ponoviti.',
    'experiencePage.meta':'20+ godina profesionalnog hospitality i F&B iskustva Zorana Kušljića: Hilton brandovi, premium hoteli, Austrija i Vorarlberg, pre-opening, opening, training i razvoj operacija.','experiencePage.hero':'20+ godina hospitality iskustva. <span class="gold">Iz prakse, ne iz teorije.</span>','experiencePage.lead':'Profesionalno iskustvo iza MB Hospitality & Managementa obuhvaća međunarodne hotelske brandove, premium objekte, austrijsko tržište, F&B management, pre-opening i opening projekte, standarde i razvoj timova.','experiencePage.founderTitle':'Hospitality karijera iz koje je nastao MB Hospitality & Management.','experiencePage.founderBio':'20+ godina iskustva u Hospitality & F&B industriji uključuje hotelske i gastronomske operacije, vođenje timova, razvoj restorana i barova, pre-opening i opening, training, service standards, beverage koncepte i business development.','experiencePage.contextTitle':'Put kojim se gradilo iskustvo.','experiencePage.clarityText':'Više od 20 godina profesionalnog iskustva oblikovano je stvarnim radom, kontinuiranim učenjem i razvojem kroz hospitality projekte.','career.eyebrow':'Profesionalni razvoj','career.title':'Put kojim se gradilo iskustvo.','career.text1':'Više od 20 godina profesionalnog iskustva gradilo se kroz rad u hotelima i hospitality objektima, vođenje operacija i timova, kontinuirano obrazovanje i stručne edukacije te sudjelovanje u pre-opening i opening projektima.','career.text2':'Profesionalne certifikacije i dodatno obrazovanje u području vina i sommelierstva dodatno su oblikovali znanje i pristup. Svako iskustvo, projekt i edukacija bili su dio razvoja načina rada koji danas stoji iza MB Hospitality & Managementa.','career.marker1':'20+ godina profesionalnog razvoja','career.marker2':'Pre-Opening & Opening','career.marker3':'Wine & Sommelier Education',
    'alt.zoranPortrait':'Zoran Kušljić, Founder & Hospitality Consultant','alt.zoranAlps':'Zoran Kušljić u alpskom okruženju u Austriji','alt.fineDiningOwner':'Fine dining detalj i prezentacija hrane','alt.wineCellar':'Vino i beverage program','alt.ownerRestaurant':'Elegantni hospitality restoran','alt.ownerBar':'Premium bar interijer','alt.foodTable':'Jela i F&B detalji'
  });
  Object.assign(T.de, {
    'home.meta':'Premium Hospitality Consulting und Management in Vorarlberg, basierend auf mehr als 20 Jahren Erfahrung in Hotellerie, Gastronomie, F&B Management, Pre-Opening, Training und Teamentwicklung.',
    'hero.line1':'20+ Jahre Hospitality-Erfahrung.','hero.line2':'Für konkrete Ergebnisse in der Praxis.','hero.sub':'Praxiswissen aus Hotels, Restaurants, Bars und F&B Management — von Pre-Opening und Eröffnung bis zu Teamentwicklung, Standards und Guest Experience.','hero.btn1':'Erfahrung','hero.meta1':'20+ Jahre Erfahrung',
    'footer.copy':'20+ Jahre Hospitality- und F&B-Erfahrung als praktische Unterstützung für Hotels, Restaurants und Bars.',
    'founder.kicker':'Gründer','founder.title':'Die Erfahrung hinter MB Hospitality & Management kommt aus dem realen Betrieb.','founder.bio1':'Mehr als 20 Jahre in Hospitality & F&B — in Hotels, Restaurants und Bars, in der Führung von Teams, bei Pre-Opening- und Opening-Projekten, Service Standards und der Entwicklung von Betrieben.','founder.bio2':'Die Erfahrung umfasst internationale Hotelmarken, 5★- und 4★-Superior-Umfelder sowie direkte Berufserfahrung in Österreich und Vorarlberg. Darauf basiert der praxisnahe Ansatz von MB Hospitality & Management.','founder.fact1':'Jahre Hospitality- & F&B-Erfahrung','founder.fact2':'Premium-Hospitality-Erfahrung','founder.fact3':'Österreich · Vorarlberg','founder.fact4':'Pre-Opening & Opening Erfahrung','founder.more':'Berufliche Erfahrung ansehen',
    'experienceBehind.title':'Die Erfahrung hinter <span class="gold">MB Hospitality & Management</span>','experienceBehind.lead':'Von internationalen Hotelmarken bis zu Premium-Betrieben in Österreich — die berufliche Erfahrung des Gründers bildet die Grundlage für die heutige Arbeit von MB Hospitality.','experienceBehind.premiumText':'Erfahrung in Premium- und Luxury-Hospitality-Umfeldern.','experienceBehind.international':'Internationale Hotelmarken','experienceBehind.austria':'Hospitality-Erfahrung in Österreich','experienceBehind.note':'Die genannten Marken, Betriebe und Projekte sind Teil des beruflichen Weges von Zoran Kušljić und geben den Kontext für die Erfahrung, auf der MB Hospitality & Management aufgebaut ist. Sie werden nicht als Kunden oder Partner von MB Hospitality & Management dargestellt.',
    'austria.title':'Internationale Erfahrung. Lokales Verständnis.','austria.text':'Falkensteiner Montafon, Löwen Hotel Montafon und Bellucci Bregenz gehören zur beruflichen Erfahrung, die in Österreich gesammelt wurde. Das Verständnis des lokalen Hospitality-Umfelds ist besonders wertvoll für die Zusammenarbeit mit Betrieben in Vorarlberg und der Alpenregion.','austria.caption':'Österreichisches und alpines Hospitality-Umfeld.',
    'opening.title':'Erfahrung mit Projekten vom ersten Tag an.','opening.lead':'Pre-Opening- und Opening-Erfahrung zeigt, dass das Know-how nicht nur aus der Führung bestehender Betriebe kommt, sondern auch aus dem Aufbau neuer Hospitality-Projekte von Beginn an.','opening.canopyType':'Pre-Opening & Opening','opening.canopyText':'Erfahrung aus der Mitarbeit an einem Pre-Opening- und Opening-Projekt einer internationalen Hotelmarke.','opening.bellucciType':'Restaurant & Bar Opening','opening.bellucciText':'Erfahrung bei der Eröffnung von Restaurant und Bar sowie beim Aufbau und der Entwicklung des Betriebs von Anfang an.','opening.scope1':'F&B Concept','opening.scope2':'Bar & Beverage Program','opening.scope3':'Menu Development','opening.scope4':'Service Standards','opening.scope5':'Operational Setup','opening.scope6':'Team Organization & Training',
    'sectorsHome.title':'Hotels. Restaurants. Bars.','sectorsHome.lead':'Unterschiedliche Umfelder und Rhythmen — mit demselben Ziel: Qualität und Standards in ein Gästeerlebnis zu übersetzen, das tatsächlich spürbar ist.',
    'services.title':'Praxiswissen für das gesamte Hospitality-System.','services.lead':'Im Fokus stehen Bereiche, in denen Erfahrung, klare Standards und die Arbeit mit Menschen konkrete Verbesserungen bewirken können.',
    'process.lead':'Ein praxisnaher Prozess, der die reale Situation in klare Schritte, Teamentwicklung und nachhaltige Verbesserungen im Alltag übersetzt.','process.5p':'Wir überprüfen die Ergebnisse und beobachten, wie die Veränderungen funktionieren, wenn der Betrieb mit voller Intensität läuft.',
    'cta.title':'Sprechen wir über Ihr Hospitality-Projekt.','cta.text':'Wenn Sie Praxiserfahrung, klare Standards und Unterstützung suchen, die den realen Rhythmus eines Betriebs versteht — sprechen wir.','cta.button':'Kontakt aufnehmen',
    'exp.title':'Erfahrung, die aus der Praxis kommt.','exp.lead':'20+ Jahre professionelle Erfahrung in Hotellerie und Gastronomie — von F&B Operations und Eröffnungen bis zur Entwicklung von Standards, Teams und neuen Hospitality-Konzepten.',
    'servicesPage.meta':'Hospitality Services auf Basis von 20+ Jahren Erfahrung: F&B Management, Pre-Opening, Service Standards, Training, Restaurant & Bar Development und Business Development.','servicesPage.hero':'Praxiswissen. <span class="gold">Klare Ergebnisse.</span>','servicesPage.lead':'Unterstützung für Hotels, Restaurants und Bars auf Basis von 20+ Jahren realer Hospitality- und F&B-Erfahrung.','servicesPage.secTitle':'Bereiche, in denen wir Erfahrung in Praxis übersetzen.','servicesPage.secLead':'Jeder Einsatz wird an Betrieb, Entwicklungsphase, Menschen und reale Prioritäten angepasst.',
    'approachPage.meta':'Praxisnaher Hospitality-Ansatz auf Basis von Erfahrung, On-site Analyse, Feedback, Training, Umsetzung und Follow-up.','approachPage.hero':'Praktische Erfahrung. <span class="gold">Konkrete Umsetzung.</span>','approachPage.lead':'Wir wissen, wie ein Standard auf Papier aussieht — und wie er funktionieren muss, wenn der Betrieb voll, das Team unter Druck und der Gast vor Ihnen ist.','approachPage.principleText':'Wir beobachten reale Bedingungen: wenn das Restaurant voll ist, Kommunikation schnell sein muss und der Standard davon abhängt, wie gut das Team ihn versteht und wiederholen kann.',
    'experiencePage.meta':'20+ Jahre professionelle Hospitality- und F&B-Erfahrung von Zoran Kušljić: Hilton-Marken, Premium-Hotels, Österreich und Vorarlberg, Pre-Opening, Opening, Training und Betriebsentwicklung.','experiencePage.hero':'20+ Jahre Hospitality-Erfahrung. <span class="gold">Aus der Praxis, nicht aus der Theorie.</span>','experiencePage.lead':'Die Erfahrung hinter MB Hospitality & Management umfasst internationale Hotelmarken, Premium-Betriebe, den österreichischen Markt, F&B Management, Pre-Opening- und Opening-Projekte, Standards und Teamentwicklung.','experiencePage.founderTitle':'Die Hospitality-Karriere, aus der MB Hospitality & Management entstanden ist.','experiencePage.founderBio':'20+ Jahre Erfahrung in Hospitality & F&B umfassen Hotel- und Gastronomiebetriebe, Teamführung, Restaurant- und Barentwicklung, Pre-Opening und Opening, Training, Service Standards, Beverage-Konzepte und Business Development.','experiencePage.contextTitle':'Der Weg, auf dem Erfahrung gewachsen ist.','experiencePage.clarityText':'Mehr als 20 Jahre Berufserfahrung wurden durch reale Hospitality-Arbeit, kontinuierliches Lernen und die Entwicklung in unterschiedlichsten Projekten geprägt.','career.eyebrow':'Berufliche Entwicklung','career.title':'Der Weg, auf dem Erfahrung gewachsen ist.','career.text1':'Mehr als 20 Jahre Berufserfahrung entstanden durch die Arbeit in Hotels und Hospitality-Betrieben, die Führung von Operations und Teams, kontinuierliche Weiterbildung und Fachschulungen sowie die Mitwirkung an Pre-Opening- und Opening-Projekten.','career.text2':'Professionelle Zertifizierungen und zusätzliche Weiterbildung im Bereich Wein und Sommellerie haben Wissen und Arbeitsweise weiter geprägt. Jede Station, jedes Projekt und jede Weiterbildung waren Teil der Entwicklung des Ansatzes, der heute hinter MB Hospitality & Management steht.','career.marker1':'20+ Jahre berufliche Entwicklung','career.marker2':'Pre-Opening & Opening','career.marker3':'Wein & Sommellerie Weiterbildung',
    'alt.zoranPortrait':'Zoran Kušljić, Founder & Hospitality Consultant','alt.zoranAlps':'Zoran Kušljić in alpiner Umgebung in Österreich','alt.fineDiningOwner':'Fine-Dining-Detail und Speisenpräsentation','alt.wineCellar':'Wein und Beverage-Programm','alt.ownerRestaurant':'Elegantes Hospitality-Restaurant','alt.ownerBar':'Premium-Bar-Interieur','alt.foodTable':'Speisen und F&B-Details'
  });
  Object.assign(T.en, {
    'home.meta':'Premium hospitality consulting and management in Vorarlberg, built on 20+ years of experience in hotels, restaurants, F&B management, pre-opening, training and team development.',
    'hero.line1':'20+ years of hospitality experience.','hero.line2':'Turned into tangible results.','hero.sub':'Practical knowledge from hotels, restaurants, bars and F&B management — from pre-opening and opening to team development, standards and guest experience.','hero.btn1':'Experience','hero.meta1':'20+ years of experience',
    'footer.copy':'20+ years of hospitality and F&B experience translated into practical support for hotels, restaurants and bars.',
    'founder.kicker':'Founder','founder.title':'The experience behind MB Hospitality & Management comes from real operations.','founder.bio1':'More than 20 years in Hospitality & F&B — across hotels, restaurants and bars, team leadership, pre-opening and opening projects, service standards and operational development.','founder.bio2':'The experience includes international hotel brands, 5★ and 4★ Superior environments, and direct professional experience in Austria and Vorarlberg. This is the foundation of MB Hospitality & Management’s practical approach.','founder.fact1':'years of Hospitality & F&B experience','founder.fact2':'premium hospitality experience','founder.fact3':'Austria · Vorarlberg','founder.fact4':'Pre-Opening & Opening experience','founder.more':'Explore professional experience',
    'experienceBehind.title':'The Experience Behind <span class="gold">MB Hospitality & Management</span>','experienceBehind.lead':'From international hotel brands to premium properties in Austria — the founder’s professional experience is the foundation of how MB Hospitality works today.','experienceBehind.premiumText':'Experience in premium and luxury hospitality environments.','experienceBehind.international':'International hotel brands','experienceBehind.austria':'Hospitality experience in Austria','experienceBehind.note':'The brands, properties and projects listed form part of Zoran Kušljić’s professional journey and provide context for the experience behind MB Hospitality & Management. They are not presented as clients or partners of MB Hospitality & Management.',
    'austria.title':'International experience. Local understanding.','austria.text':'Falkensteiner Montafon, Löwen Hotel Montafon and Bellucci Bregenz are part of professional experience gained in Austria. Understanding the local hospitality environment is especially valuable when working with properties in Vorarlberg and the Alpine region.','austria.caption':'Austrian and Alpine hospitality environment.',
    'opening.title':'Experience with projects from day one.','opening.lead':'Pre-opening and opening experience shows that the expertise is not limited to running established properties, but also includes setting up new hospitality projects from the ground up.','opening.canopyType':'Pre-Opening & Opening','opening.canopyText':'Experience from participating in the pre-opening and opening project of an international hotel brand.','opening.bellucciType':'Restaurant & Bar Opening','opening.bellucciText':'Experience in opening a restaurant and bar and in setting up and developing the operation from the very beginning.','opening.scope1':'F&B Concept','opening.scope2':'Bar & Beverage Program','opening.scope3':'Menu Development','opening.scope4':'Service Standards','opening.scope5':'Operational Setup','opening.scope6':'Team Organization & Training',
    'sectorsHome.title':'Hotels. Restaurants. Bars.','sectorsHome.lead':'Different environments and different rhythms — with the same goal: turning quality and standards into a guest experience that can actually be felt.',
    'services.title':'Practical knowledge across the hospitality system.','services.lead':'The focus is on areas where experience, clear standards and working with people can create concrete improvement.',
    'process.lead':'A practical process that turns the real situation into clear steps, team development and improvements that remain part of everyday work.','process.5p':'We return to the results and observe how the changes work when the property is operating at full intensity.',
    'cta.title':'Let’s talk about your hospitality project.','cta.text':'If you are looking for hands-on experience, clear standards and support that understands the real rhythm of a property — let’s talk.','cta.button':'Contact us',
    'exp.title':'Experience built in practice.','exp.lead':'20+ years of professional experience in hospitality and gastronomy — from F&B operations and openings to standards, team development and new hospitality concepts.',
    'servicesPage.meta':'Hospitality services backed by 20+ years of experience: F&B management, pre-opening, service standards, training, restaurant & bar development and business development.','servicesPage.hero':'Practical knowledge. <span class="gold">Clear results.</span>','servicesPage.lead':'Support for hotels, restaurants and bars built on 20+ years of real Hospitality & F&B experience.','servicesPage.secTitle':'Areas where experience becomes practical action.','servicesPage.secLead':'Every engagement is adapted to the property, its stage of development, its people and its real priorities.',
    'approachPage.meta':'A practical hospitality approach built on experience, on-site analysis, feedback, training, implementation and follow-up.','approachPage.hero':'Practical experience. <span class="gold">Concrete implementation.</span>','approachPage.lead':'We know what a standard looks like on paper — and how it has to work when the property is full, the team is under pressure and the guest is right in front of you.','approachPage.principleText':'We observe real conditions: when the restaurant is full, communication has to be fast and the standard depends on how well the team understands and can repeat it.',
    'experiencePage.meta':'20+ years of professional hospitality and F&B experience of Zoran Kušljić: Hilton brands, premium hotels, Austria and Vorarlberg, pre-opening, opening, training and operational development.','experiencePage.hero':'20+ years of hospitality experience. <span class="gold">Built in practice, not theory.</span>','experiencePage.lead':'The experience behind MB Hospitality & Management includes international hotel brands, premium properties, the Austrian market, F&B management, pre-opening and opening projects, standards and team development.','experiencePage.founderTitle':'The hospitality career behind MB Hospitality & Management.','experiencePage.founderBio':'20+ years of Hospitality & F&B experience includes hotel and restaurant operations, team leadership, restaurant and bar development, pre-opening and opening, training, service standards, beverage concepts and business development.','experiencePage.contextTitle':'The path that shaped the experience.','experiencePage.clarityText':'More than 20 years of professional experience have been shaped by real hospitality work, continuous learning and development across a wide range of projects.','career.eyebrow':'Professional development','career.title':'The path that shaped the experience.','career.text1':'More than 20 years of professional experience were built through work in hotels and hospitality properties, leading operations and teams, continuous education and specialist training, and involvement in pre-opening and opening projects.','career.text2':'Professional certifications and additional education in wine and sommellerie further shaped the knowledge and approach. Every role, project and learning experience contributed to the way of working that stands behind MB Hospitality & Management today.','career.marker1':'20+ years of professional development','career.marker2':'Pre-Opening & Opening','career.marker3':'Wine & Sommelier Education',
    'alt.zoranPortrait':'Zoran Kušljić, Founder & Hospitality Consultant','alt.zoranAlps':'Zoran Kušljić in an Alpine setting in Austria','alt.fineDiningOwner':'Fine dining detail and food presentation','alt.wineCellar':'Wine and beverage programme','alt.ownerRestaurant':'Elegant hospitality restaurant','alt.ownerBar':'Premium bar interior','alt.foodTable':'Food and F&B details'
  });


  Object.assign(T.hr, {
    'contactPage.hero':'Razgovarajmo o vašem <span class="gold">hospitality projektu.</span>','contactPage.lead':'Hotel, restoran ili bar — krenimo od vaših ciljeva, tima, standarda i onoga što želite razviti.','contactPage.side':'Prvi razgovor može biti jednostavan: gdje ste danas, što želite razviti i gdje iskustvo gosta, tim ili standardi imaju najviše prostora za napredak.','servicesPage.o6':'Sustav koji funkcionira u praksi','restaurantsPage.lead':'Promatramo servis, workflow, komunikaciju, tim i iskustvo gosta upravo u trenutku kada sve mora funkcionirati bez improvizacije.','restaurantsPage.introTitle':'Dobar restoran nije samo proizvod. To je precizno vođen sustav.','barsPage.introTitle':'Premium bar nije definiran samo koktelom, nego načinom na koji cijeli sustav radi.'
  });
  Object.assign(T.de, {
    'contactPage.hero':'Sprechen wir über Ihr <span class="gold">Hospitality-Projekt.</span>','contactPage.lead':'Hotel, Restaurant oder Bar — beginnen wir bei Ihren Zielen, Ihrem Team, Ihren Standards und dem, was Sie weiterentwickeln möchten.','contactPage.side':'Das erste Gespräch kann einfach sein: Wo stehen Sie heute, was möchten Sie entwickeln und wo gibt es beim Gästeerlebnis, im Team oder bei Standards das größte Potenzial?','servicesPage.o6':'Ein System, das in der Praxis funktioniert'
  });
  Object.assign(T.en, {
    'contactPage.hero':'Let’s talk about your <span class="gold">hospitality project.</span>','contactPage.lead':'Hotel, restaurant or bar — let’s start with your goals, your team, your standards and what you want to develop.','contactPage.side':'The first conversation can be simple: where are you today, what do you want to develop, and where do the guest experience, the team or the standards have the most room to improve?','servicesPage.o6':'A system that works in practice'
  });



  // 2026-08-20 — concise professional-experience path and final localized polish
  Object.assign(T.hr, {
    'path.eyebrow':'Profesionalni razvoj','path.title':'Put kojim se gradilo iskustvo.','path.lead':'Više od 20 godina znanja gradilo se kroz stvarne uloge, projekte, edukacije i F&B praksu — bez forme klasičnog CV-a.','path.1':'Hoteli','path.2':'Management','path.3':'Edukacije','path.4':'Projekti','path.5':'Certifikacije','path.6':'F&B','path.7':'Consulting','alt.alpineEditorial':'Luksuzni alpski hospitality objekt u planinskom okruženju'
  });
  Object.assign(T.de, {
    'path.eyebrow':'Berufliche Entwicklung','path.title':'Der Weg, auf dem Erfahrung gewachsen ist.','path.lead':'Mehr als 20 Jahre Wissen entstanden durch reale Rollen, Projekte, Weiterbildung und F&B-Praxis — ohne die Form eines klassischen Lebenslaufs.','path.1':'Hotels','path.2':'Management','path.3':'Weiterbildung','path.4':'Projekte','path.5':'Zertifizierungen','path.6':'F&B','path.7':'Consulting','alt.alpineEditorial':'Premium Alpine Hospitality in einer Berglandschaft'
  });
  Object.assign(T.en, {
